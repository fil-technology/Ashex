...
public struct FileSystemTool: Tool {
    ...
    public let contract = ToolContract(
        name: "filesystem",
        description: "Inspect, search, edit, move, copy, and delete files or directories within the workspace",
        kind: .embedded,
        category: "filesystem",
        operationArgumentKey: "operation",
        operations: [
            .init(name: "read_text_file", description: "Read a UTF-8 text file", mutatesWorkspace: false, validationArtifacts: ["<file>"], inspectedPathArguments: ["path"], progressSummary: "read file", arguments: [.init(name: "path", description: "Workspace-relative file path", type: .string, required: true)]),
            .init(name: "write_text_file", description: "Write a UTF-8 text file", mutatesWorkspace: true, changedPathArguments: ["path"], progressSummary: "edited file", approval: .init(risk: .medium, summary: "Write file", reasonTemplate: "{{path}}"), arguments: [.init(name: "path", description: "Workspace-relative file path", type: .string, required: true), .init(name: "content", description: "Full replacement content", type: .string, required: true), .init(name: "create_directories", description: "Create parent directories if needed", type: .bool, required: false)]),
            .init(name: "replace_in_file", description: "Replace text in a file", mutatesWorkspace: true, changedPathArguments: ["path"], progressSummary: "updated file text", approval: .init(risk: .medium, summary: "Replace text in file", reasonTemplate: "{{path}}"), arguments: [.init(name: "path", description: "Workspace-relative file path", type: .string, required: true), .init(name: "old_text", description: "Text to replace", type: .string, required: true), .init(name: "new_text", description: "Replacement text", type: .string, required: false), .init(name: "replace_all", description: "Replace every occurrence", type: .bool, required: false)]),
            .init(name: "apply_patch", description: "Apply multiple targeted edits in one file", mutatesWorkspace: true, changedPathArguments: ["path"], progressSummary: "patched file", approval: .init(risk: .medium, summary: "Apply patch to file", reasonTemplate: "{{path}}"), arguments: [.init(name: "path", description: "Workspace-relative file path", type: .string, required: true), .init(name: "edits", description: "Array of edit objects", type: .array, required: true)]),
            .init(name: "list_directory", description: "List directory entries", mutatesWorkspace: false, inspectedPathArguments: ["path"], progressSummary: "explored directory", arguments: [.init(name: "path", description: "Directory path", type: .string, required: false)]),
            .init(name: "create_directory", description: "Create a directory", mutatesWorkspace: true, changedPathArguments: ["path"], progressSummary: "created directory", approval: .init(risk: .low, summary: "Create directory", reasonTemplate: "{{path}}"), arguments: [.init(name: "path", description: "Directory path", type: .string, required: true)]),
            .init(name: "delete_path", description: "Delete a file or directory", mutatesWorkspace: true, changedPathArguments: ["path"], progressSummary: "deleted path", approval: .init(risk: .high, summary: "Delete path", reasonTemplate: "{{path}}"), arguments: [.init(name: "path", description: "Path to delete", type: .string, required: true)]),
            .init(name: "move_path", description: "Move or rename a path", mutatesWorkspace: true, changedPathArguments: ["source_path", "destination_path"], progressSummary: "moved path", approval: .init(risk: .medium, summary: "Move path", reasonTemplate: "{{source_path}} -> {{destination_path}}"), arguments: [.init(name: "source_path", description: "Source path", type: .string, required: true), .init(name: "destination_path", description: "Destination path", type: .string, required: true)]),
            .init(name: "copy_path", description: "Copy a file or directory", mutatesWorkspace: true, changedPathArguments: ["source_path", "destination_path"], progressSummary: "copied path", approval: .init(risk: .low, summary: "Copy path", reasonTemplate: "{{source_path}} -> {{destination_path}}"), arguments: [.init(name: "source_path", description: "Source path", type: .string, required: true), .init(name: "destination_path", description: "Destination path", type: .string, required: true)]),
            .init(name: "file_info", description: "Inspect file metadata", mutatesWorkspace: false, validationArtifacts: ["<file>"], inspectedPathArguments: ["path"], progressSummary: "inspected file", arguments: [.init(name: "path", description: "Path to inspect", type: .string, required: false)]),
            .init(name: "find_files", description: "Find files by name fragment", mutatesWorkspace: false, inspectedPathArguments: ["path"], progressSummary: "searched file names", arguments: [.init(name: "path", description: "Search root", type: .string, required: false), .init(name: "query", description: "Name fragment to search for", type: .string, required: true), .init(name: "max_results", description: "Maximum results to return", type: .number, required: false)]),
            .init(name: "search_text", description: "Search UTF-8 files for text", mutatesWorkspace: false, inspectedPathArguments: ["path"], progressSummary: "searched file contents", arguments: [.init(name: "path", description: "Search root", type: .string, required: false), .init(name: "query", description: "Text query", type: .string, required: true), .init(name: "max_results", description: "Maximum matches to return", type: .number, required: false)]),
        ],
        tags: ["core", "workspace", "files"]
    )
