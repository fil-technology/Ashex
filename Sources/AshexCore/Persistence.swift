...
public protocol PersistenceStore: Sendable {
    ...
    func upsertWorkingMemory(runID: UUID, currentTask: String, currentPhase: String?, explorationTargets: [String], pendingExplorationTargets: [String], inspectedPaths: [String], changedPaths: [String], recentFindings: [String], completedStepSummaries: [String], unresolvedItems: [String], validationSuggestions: [String], summary: String, now: Date) throws -> WorkingMemoryRecord
