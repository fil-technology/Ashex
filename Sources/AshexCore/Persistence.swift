...
public protocol PersistenceStore: Sendable {
    ...
    func upsertWorkingMemory(runID: UUID, currentTask: String, currentPhase: String?, explorationTargets: [String], pendingExplorationTargets: [String], rejectedExplorationTargets: [String], inspectedPaths: [String], changedPaths: [String], recentFindings: [String], completedStepSummaries: [String], unresolvedItems: [String], validationSuggestions: [String], plannedChangeSet: [String], patchObjectives: [String], carryForwardNotes: [String], summary: String, now: Date) throws -> WorkingMemoryRecord
