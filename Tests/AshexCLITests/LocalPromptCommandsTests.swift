...
@Test func parsesWorkspaceHelperCommands() {
    ...
    #expect(LocalPromptCommand.parse("list files") == .simpleWorkspace(.listDirectory(path: ".")))
    #expect(LocalPromptCommand.parse("/mkdir Reports") == .simpleWorkspace(.createDirectory(path: "Reports")))
    #expect(LocalPromptCommand.parse("create a folder named Reports") == .simpleWorkspace(.createDirectory(path: "Reports")))
